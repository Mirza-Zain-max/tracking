...
//                     </div>
//                 </div>
//                 <p className='text-center fs-2 text-light'>Loading...</p>
//             </StyledWrapper>
//         </main>
...
const Loader = () => {
  return (
            <main className='d-flex justify-content-center align-items-center' style={{ height: '100vh', backgroundColor: "#12242b" }} >
    <StyledWrapper>
      <div id="page">
        <div id="container">
          <div id="ring" />
          ...
          <div id="ring" />
          <div id="ring" />
          <div id="h3" className='text-light'>loading</div>
        </div>
      </div>
    </StyledWrapper>
            </main>
